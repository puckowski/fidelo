...
def parse_args(configure_parser=None):
    ...
    parser.add_argument("--prompt", default="metal")
    ...
    parser.add_argument("--duration-seconds", type=float, default=45.0, help="Target output duration in seconds. If set, overrides --clip-count.")
    ...
    parser.add_argument("--rank-choice-prob", type=float, default=0.08)
    parser.add_argument("--rank-choice-top", type=int, default=4)
    parser.add_argument("--rank-choice-temperature", type=float, default=0.30)
    parser.add_argument("--source-candidates", type=int, default=20)
    parser.add_argument("--source-window", type=int, default=512)
    parser.add_argument("--source-overlap", type=int, default=512)
    parser.add_argument("--max-source-seconds", type=float, default=30.0)
    parser.add_argument("--proposal-weight", type=float, default=0.70)
    parser.add_argument("--continuity-weight", type=float, default=2.0)
    parser.add_argument("--match-weight", type=float, default=0.65)
    parser.add_argument("--scan-step-divisor", type=int, default=8)
    parser.add_argument("--source-strength", type=float, default=0.88)
    ...
    parser.add_argument("--window-energy-check-top", type=int, default=64)
    parser.add_argument("--min-window-rms", type=float, default=0.0035)
    parser.add_argument("--min-window-peak", type=float, default=0.015)
    parser.add_argument("--clip-energy-check-seconds", type=float, default=2.0)
    parser.add_argument("--min-clip-rms", type=float, default=0.006)
    parser.add_argument("--min-clip-peak", type=float, default=0.028)
    ...
    parser.add_argument("--clip-retry-count", type=int, default=8)
    parser.add_argument("--theme-seconds", type=float, default=7.0)
    parser.add_argument("--theme-top-n", type=int, default=16)
    parser.add_argument("--theme-temperature", type=float, default=0.40)
    parser.add_argument("--theme-repeat-window", type=int, default=2)
    parser.add_argument("--theme-repeat-bonus", type=float, default=0.8)
    parser.add_argument("--theme-repeat-decay", type=float, default=0.50)
    parser.add_argument("--theme-crossfade-ms", type=int, default=900)
    ...
    parser.add_argument("--intro-theme-seconds", type=float, default=7.0)
    parser.add_argument("--intro-theme-temperature", type=float, default=0.35)
    parser.add_argument("--intro-repeat-bonus", type=float, default=8.0)
    parser.add_argument("--intro-source-strength", type=float, default=0.92)
    parser.add_argument("--intro-creative-token-mix", type=float, default=0.02)
    parser.add_argument("--intro-rank-choice-prob", type=float, default=0.03)
    parser.add_argument("--song-intro-fade-ms", type=int, default=450)
    parser.add_argument("--beginning-to-regular-crossfade-seconds", type=float, default=2.0)
    parser.add_argument("--creative-span-count", type=int, default=3)
    parser.add_argument("--creative-span-min", type=int, default=8)
    parser.add_argument("--creative-span-max", type=int, default=20)
    parser.add_argument("--creative-token-mix", type=float, default=0.04)
    parser.add_argument("--fade-ms", type=int, default=1200)
    parser.add_argument("--seed", type=int, default=19568)
...
def build_section_candidate_entries(candidate_entries: List[Dict], section_name: str, intro_theme_top_n: int) -> List[Dict]:
    ...
    if section_name == "intro":
        ...
        return intro_pool[:max(1, int(intro_theme_top_n))]
...
def main():
    ...
    for clip_idx in range(clip_count):
        ...
        section_entries = build_section_candidate_entries(candidate_entries, section_name, args.intro_theme_top_n)
    ...
    output = structured.stitch_song_clips(
        clips,
    ...
    print(f"Saved intro/body sticky crossfaded source-creative-ranked latent audio to {output_path}")
